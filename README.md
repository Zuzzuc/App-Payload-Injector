...
<br>
# NOTE
<b>Expect a update during the coming week improving execution time tenfolds as well as adding a real input handler. This update will also include new options.</b>
